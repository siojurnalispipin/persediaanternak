      ...
      <div class="col-lg-3 col-xs-6" style="width:50%">
        ...
        <div style="background-color:#69BE69;color:#fff;height:110px" class="small-box">
          <?php  
            ...
            ?>
          <div class="inner">            
            <h2 style="text-align:center"><?php echo $data['jumlah']; ?><p>Jumlah Hewan</p></h3>            
          </div>
          <div class="icon">
      ...
      <div class="col-lg-3 col-xs-6" style="width:50%">
        ...
        <div style="background-color:#CE794E;color:#fff;height:110px" class="small-box">
          <?php  
            ...
            ?>
          <div class="inner">            
            <h2 style="text-align:center"><?php echo $data['jumlah']; ?><p>Jumlah Pakan</p></h3>            
          </div>
          <div class="icon">
            <i class="fa fa-file-text-o"></i>
          </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-xs-6">
        ...
        <div style="background-color:#dd4b39;color:#fff" class="small-box">
          ...
          <a href="?module=laporanmasuk" class="small-box-footer" title="Cetak Laporan" data-toggle="tooltip"><i class="fa fa-print"></i></a>
        </div>
      </div><!-- ./col -->
