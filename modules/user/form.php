          ...
          <form role="form" class="form-horizontal" method="POST" action="modules/user/proses.php?act=insert" enctype="multipart/form-data">
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <select class="form-control" name="acces" required>
                    <option value=""></option>
...
elseif ($_GET['form']=='edit') { 
      ...
      $query = mysqli_query($mysqli, "SELECT * FROM anggota WHERE user_id='$_GET[id]'") 
          ...
          <form role="form" class="form-horizontal" method="POST" action="modules/user/proses.php?act=update" enctype="multipart/form-data">
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="phone" autocomplete="off" maxlength="13" onKeyPress="return goodchars(event,'0123456789',this)" value="<?php echo $data['phone']; ?>">
                </div>
              </div>
            ...
            <div class="form-group">
                ...
                <?php  
                if ($data['photo']=="") { ?>
                  <img style="border:1px solid #eaeaea;border-radius:5px;" src="images/user/user.png" width="128">
                <?php
                }
                else { ?>
                  <img style="border:1px solid #eaeaea;border-radius:5px;" src="images/user/<?php echo $data['photo']; ?>" width="128">
                <?php
                }
                ?>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <select class="form-control" name="acces" required>
                    <option value="<?php echo $data['acces']; ?>"><?php echo $data['acces']; ?></option>
