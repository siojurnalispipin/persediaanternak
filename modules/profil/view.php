...
if (isset($_SESSION['user_id'])) {
  ...
  $query = mysqli_query($mysqli, "SELECT * FROM anggota WHERE user_id='$_SESSION[user_id]'") 
        ...
        <form role="form" class="form-horizontal" method="POST" action="?module=form_profil" enctype="multipart/form-data">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <?php  
              if ($data['photo']=="") { ?>
                <img style="border:1px solid #eaeaea;border-radius:50px;" src="images/user/user.png" width="75">
              <?php
              }
              else { ?>
                <img style="border:1px solid #eaeaea;border-radius:50px;" src="images/user/<?php echo $data['photo']; ?>" width="75">
              <?php
              }
              ?>
              </label>
              <label style="font-size:25px;margin-top:10px;" class="col-sm-8"><?php echo $data['username']; ?></label>
            </div>
            <hr>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <label style="text-align:left" class="col-sm-8 control-label">: <?php echo $data['phone']; ?></label>
            </div>

            <div class="form-group">
              <label class="col-sm-2 control-label">Hak Akses</label>
              <label style="text-align:left" class="col-sm-8 control-label">: <?php echo $data['acces']; ?></label>
            </div>
