...
if ($_GET['form']=='add') { ?> 
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-edit icon-title"></i>Tambah Barang Masuk
    </h1>
    <ol class="breadcrumb">
      <li><a href="?module=home"><i class="fa fa-home"></i> Beranda </a></li>
      <li><a href="?module=barangmasuk"> Barang Masuk </a></li>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" action="modules/barangmasuk/proses.php?act=insert" method="POST">
            <div class="box-body">
              <?php  
...
?>
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-edit icon-title"></i> Ubah Barang Masuk
    </h1>
    <ol class="breadcrumb">
      <li><a href="?module=home"><i class="fa fa-home"></i> Beranda </a></li>
      <li><a href="?module=barangmasuk"> Barang Masuk </a></li>
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" action="modules/barangmasuk/proses.php?act=update" method="POST">
            <div class="box-body">
              <?php  
              // fungsi untuk membuat id transaksi
              require_once "config/database.php";
