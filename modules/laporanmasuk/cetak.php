...
if (isset($_GET['tgl_awal'])) {
    ...
    $query = mysqli_query($mysqli, "SELECT transaction_id,item_id,description,amount,tracked_by,misc,transaction_date
                                    FROM barang_masuk WHERE transaction_date BETWEEN '$tgl_awal' AND '$tgl_akhir'
                                    ORDER BY transaction_id ASC") // fungsi query untuk menampilkan data dari tabel obat masuk
...
<html xmlns="http://www.w3.org/1999/xhtml"> <!-- Bagian halaman HTML yang akan konvert -->
    <head>
        ...
        <title>LAPORAN PAKAN DAN TERNAK MASUK</title>
        <link rel="stylesheet" type="text/css" href="../../assets/css/laporan.css" />
    </head>
    <body>
        <div id="title">
            LAPORAN PAKAN DAN TERNAK MASUK
        </div>
    <?php  
            ...
            <table width="100%" border="0.3" cellpadding="0" cellspacing="0">
                <thead style="background:#e8ecee">
                    <tr class="tr-title">
                        ...
                        <th height="20" align="center" valign="middle">KODE BIBIT & PAKAN</th>
                        <th height="20" align="center" valign="middle">NAMA BIBIT & PAKAN</th>
    ...
    // jika data tidak ada
        ...
        while ($data = mysqli_fetch_assoc($query)) {
            ...
            echo "  <tr>
                        ...
                        <td width='80' height='13' align='center' valign='middle'>$data[description]</td>
                        <td style='padding-left:5px;' width='155' height='13' valign='middle'>$data[amount]</td>
                        <td style='padding-right:10px;' width='100' height='13' align='right' valign='middle'>$data[tracked_by]</td>
                        <td width='80' height='13' align='center' valign='middle'>$data[misc]</td>
