...
<section class="content-header">
  <h1>
    <i class="fa fa-sign-in icon-title"></i> Data Bibit / Ternak Sakit
  
    <a class="btn btn-primary btn-social pull-right" href="?module=form_ternak_sakit&form=add" title="Tambah Data" data-toggle="tooltip">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            <thead>
              <tr>
                ...
                <th class="center">Kode Ternak sakit</th>
                <th class="center">Tanggal</th>
                <th class="center">Kode Bibit & Ternak</th>
                <th class="center">Nama Bibit & Ternak</th>
                <th class="center">Jumlah Sakit</th>
