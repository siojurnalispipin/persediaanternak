...
elseif(isset($_GET['tgl_awal'])){
    ...
    $query = mysqli_query($mysqli, "SELECT transaction_id,item_id,description,amount,tracked_by,misc,transaction_date
                                    FROM barang_keluar WHERE item_id > 70000 and misc = 'Terjual' and transaction_date >= '$tgl_awal' AND transaction_date <= '$tgl_akhir' ORDER BY item_id ASC") // fungsi query untuk menampilkan data dari tabel obat masuk
...
<head>
    ...
    <title>LAPORAN HEWAN KELUAR</title>
    <link rel="stylesheet" type="text/css" href="../../assets/css/laporan.css" />
</head>

<body>
    <div id="title">
        LAPORAN HEWAN KELUAR
    </div>
    <?php  
