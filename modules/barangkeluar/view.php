...
<section class="content-header">
  <h1>
    <i class="fa fa-folder-o icon-title"></i> Barang Keluar

    <a class="btn btn-primary btn-social pull-right" href="?module=form_barangkeluar&form=add" title="Tambah Data" data-toggle="tooltip">
  ...
  <div class="row">
    ...
    elseif ($_GET['alert'] == 1) {
      echo "<div class='alert alert-success alert-dismissable'>
              ...
              <p style='color:black;'>Data Barang Keluar baru berhasil disimpan.</p>
            </div>";
    }
    // jika alert = 2
    ...
    elseif ($_GET['alert'] == 2) {
      echo "<div class='alert alert-success alert-dismissable'>
              <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
              <h4 style='color:black;'>  <i class='icon fa fa-check-circle'></i> Sukses!</h4>
              <p style='color:black;'>Data Barang Keluar berhasil diubah.</p>
            </div>";
    }
    // jika alert = 3
    ...
    elseif ($_GET['alert'] == 3) {
      echo "<div class='alert alert-success alert-dismissable'>
              <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
              <h4 style='color:black;'>  <i class='icon fa fa-check-circle'></i> Sukses!</h4>
              <p style='color:black;'>Data Barang Keluar berhasil dihapus.</p>
            </div>";
    }
    // jika alert = 4
    // tampilkan pesan Sukses "Data Keluar berhasil dihapus"
    elseif ($_GET['alert'] == 4) {
      echo "<div class='alert alert-success alert-dismissable'>
              ...
              <p style='color:black;'>Data Barang Keluar Gagal dimasukkan.</p>
            </div>";
    }
    ?>
      ...
      <div class="box box-primary">
        <div class="box-body">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            $query = $mysqli->query("SELECT * FROM barang_keluar ORDER BY transaction_id DESC");
